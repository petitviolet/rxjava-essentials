...
public class GroupByExampleFragment extends Fragment {
    ...
    private void loadList(List<AppInfo> apps) {
        ...
        Observable<GroupedObservable<String, AppInfo>> groupedItems =
                Observable
                        ...
                        .map(appInfo -> {
                            ...
                            String d = formatter.format(new Date(appInfo.getLastUpdateTime()));
                            appInfo.setName("" + appInfo.getName() + ":" + d);
                            return appInfo;
                        })
                        .groupBy(appInfo -> {
                            SimpleDateFormat formatter = new SimpleDateFormat("MM/yyyy");
        ...
        Observable.merge(groupedItems).subscribe(new Observer<AppInfo>() {
            @Override
